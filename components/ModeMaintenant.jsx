...
import styles from '../styles/ModeMaintenant.module.css';

const ModeMaintenant = () => {
	const images = [
		{
			src: [
	...
	return (
		<>
			<div className={styles.pleinFeu}>
				<h3 className={styles.h3}>À LA MODE MAINTENANT</h3>
				<Link href='#'>
					<span>Voir plus</span>
				...
				{images.slice(0, 4).map((item, index) => (
					<div className={styles.box} key={index}>
						...
						<div className={styles.premierImg}>
							...
							<span data-text={item.description}></span>
						</div>
					</div>
				))}
			</div>
